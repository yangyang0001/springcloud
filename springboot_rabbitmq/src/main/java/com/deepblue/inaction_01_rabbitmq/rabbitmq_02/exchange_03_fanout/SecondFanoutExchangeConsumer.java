...
public class SecondFanoutExchangeConsumer {

	public static final String QUEUE_NAME = "MY_FANOUT_QUEUE_02";
		...
		try {
			...
			Consumer consumer = new DefaultConsumer(channel) {
				...
				public void handleDelivery(String consumerTag, Envelope envelope, BasicProperties properties,
					...
					System.out.println(SecondFanoutExchangeConsumer.class.getSimpleName() + "消费信息:--------->" + new String(body, "UTF-8"));
					try {
